  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link
          href={"/memberLogin"}
          className={pathname.includes("/memberLogin") ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.includes("/memberLogin") ? activeIcon : inactiveIcon}
          >
            <path
        ...
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.includes("/odLogin") ? activeIcon : inactiveIcon}
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
...
<Link
          href={"/agentList"}
          className={pathname.includes("/agentList") ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.includes("/agentList") ? activeIcon : inactiveIcon}
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
